...
class SignUpViewController: UIViewController {
    ...
    private func createUser() {
        guard let email = mailTf.text, let password = passwordTf.text,
            let confirmPassword = secondPasswrodTf.text else {
            return
        }
            ...
            AuthService.shared.register(email: email,
                                        ...
                                        confirmPassword: confirmPassword) { result in
                                            ...
                                            case .success(let user):
                                                ...
                                                let viewController = DetailPersonViewController(currentUser: user)
...
extension SignUpViewController {
    ...
    private func setupElements() {
        ...
        let stack = UIStackView(arrangedSubviews: [mailStackVIew,
                                                   passwordStackVIew, confirmPasswordStackVIew, registerButton])
        stack.axis = .vertical
        stack.spacing = 40
