    ...
    private func logIn() {
       ...
       switch result {
                ...
                case .failure(let error):
                    ...
                    let detailVievController = DetailPersonViewController(currentUser: user)
                    detailVievController.modalPresentationStyle = .fullScreen
                    self.present(detailVievController,
                                  animated: true,
                                completion: nil)
                                                }
                                            }
