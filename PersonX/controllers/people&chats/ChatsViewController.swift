...
extension ChatsViewController {
    ...
    dataSource = UICollectionViewDiffableDataSource<Section,
        ModelChat>(collectionView: collectionView!) { (collectionView, indexPath, modelChat) -> UICollectionViewCell? in
            ...
            case .waitingChat:
                ...
                model: modelChat, indexPath: indexPath)
            }
        }
...
extension ChatsViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .waitingChat:
            ...
            self.present(requestVc, animated: true, completion: nil)
        case .activeChat:
            let viewController = ChatViewController(user: muser, chat: chat)
